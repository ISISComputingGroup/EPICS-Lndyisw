...
class LndyiswTests(unittest.TestCase):
    ...
    @parameterized.expand([("_odds", "1,0,1,0,1,0,1,0"),("_even", "0,1,0,1,0,1,0,1"),("_all", "1,1,1,1,1,1,1,1")
    ,("_first_half", "1,1,1,1,0,0,0,0"),("_second_half", "0,0,0,0,1,1,1,1")])
    ...
    @parameterized.expand([("_index_1", 10, "AA"),("_index_2", 20, "BB"),("_index_3", 30, "CC"),
    ("_index_4", 40, "DD"),("_index_5", 50, "EE"),("_index_6", 60, "FF"),("_index_7", 70, "GG"),
    ("_index_8", 80, "HH")])
